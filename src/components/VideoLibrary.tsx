        ...
        <div className="grid grid-cols-2 gap-1.5 mt-3">
          ...
          {onEdit && video.provider !== "avatar" && (
            <button
              ...
              className="col-span-2 inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl text-xs font-bold uppercase tracking-wide transition-all hover:scale-[1.02] active:scale-[0.97] cursor-pointer"
