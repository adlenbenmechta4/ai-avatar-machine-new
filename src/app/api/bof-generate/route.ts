...
const WAREHOUSE_SCENE_PROMPT =
  "Multiple copies of this product arranged in neat rows on warehouse shelving in a large, modern fulfillment center or big-box retail store. Show many identical units of the product stacked and organized together in bulk, like warehouse inventory ready to ship. The products fill multiple shelf positions with their labels and packaging clearly visible and facing the camera. The scene shows tall rows of shelving units filled with products, cardboard shipping boxes, and industrial lighting overhead. The impression is of a massive warehouse full of this exact product — abundant inventory at wholesale scale. Clean, organized, professional logistics environment. Bright, even lighting. Photorealistic, high quality product photography style.";

const WAREHOUSE_VIDEO_PROMPT =
  "A smooth camera glide through a modern warehouse, revealing multiple copies of the same product arranged in neat rows on tall shelving units. The camera slowly pushes in past shelves stacked with many identical products in bulk, like bulk inventory in a fulfillment center. Industrial warehouse lighting creates clean, bright illumination. The products fill the shelves with their labels clearly visible. Professional, clean atmosphere showing abundant wholesale inventory. The products stay perfectly still and in focus throughout. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.";
