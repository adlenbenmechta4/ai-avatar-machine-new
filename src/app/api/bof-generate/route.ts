...
const VIDEO_MOTION_PROMPTS: Record<string, string> = {
  "kitchen-counter":
    "A person holding a smartphone walks toward the product on a kitchen countertop. Real handheld footage with natural camera shake and slight side-to-side sway. Dolly in: the camera physically moves forward through 3D space — nearby objects like the coffee maker pass by faster while the product stays centered, creating a parallax depth effect. NOT a digital zoom or image scale — the camera actually travels through the room. After reaching close to the product, the camera slowly pulls back, walking away and revealing the full kitchen with marble countertops, coffee maker and fresh fruits. Warm, inviting kitchen atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "bathroom-counter":
    "A person holding a smartphone walks toward the product on a bathroom counter. Real handheld footage with natural camera shake and slight side-to-side sway. Dolly in: the camera physically moves forward through 3D space — nearby objects pass by faster while the product stays centered, creating a parallax depth effect. NOT a digital zoom or image scale — the camera actually travels through the room. After reaching close to the product, the camera slowly pulls back, walking away and revealing the full bathroom with marble countertop and modern fixtures. Clean, fresh atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "bedroom-nightstand":
    "A person holding a smartphone walks toward the product on a bedroom nightstand. Real handheld footage with natural camera shake and slight side-to-side sway. Dolly in: the camera physically moves forward through 3D space — nearby objects like the lamp pass by faster while the product stays centered, creating a parallax depth effect. NOT a digital zoom or image scale — the camera actually travels through the room. After reaching close to the product, the camera slowly pulls back, walking away and revealing the cozy bedroom with soft blankets and pillows. Intimate, warm atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "living-room":
    "A person holding a smartphone walks toward the product on a living room coffee table. Real handheld footage with natural camera shake and slight side-to-side sway. Dolly in: the camera physically moves forward through 3D space — nearby objects like the couch pass by faster while the product stays centered, creating a parallax depth effect. NOT a digital zoom or image scale — the camera actually travels through the room. After reaching close to the product, the camera slowly pulls back, walking away and revealing the full living room with modern couch and stylish decor. Comfortable, lifestyle atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "office-desk":
    "A person holding a smartphone walks toward the product on an office desk. Real handheld footage with natural camera shake and slight side-to-side sway. Dolly in: the camera physically moves forward through 3D space — nearby objects like the laptop pass by faster while the product stays centered, creating a parallax depth effect. NOT a digital zoom or image scale — the camera actually travels through the room. After reaching close to the product, the camera slowly pulls back, walking away and revealing the full workspace with laptop and notepad. Professional atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "outdoor-patio":
    "A person holding a smartphone walks toward the product on an outdoor patio table. Real handheld footage with natural camera shake and slight side-to-side sway. Dolly in: the camera physically moves forward through 3D space — nearby objects like plant pots pass by faster while the product stays centered, creating a parallax depth effect. NOT a digital zoom or image scale — the camera actually travels through the space. After reaching close to the product, the camera slowly pulls back, walking away and revealing the full patio with plants and outdoor furniture. Fresh, bright outdoor atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "vanity-mirror":
    "A person holding a smartphone walks toward the product on a vanity table. Real handheld footage with natural camera shake and slight side-to-side sway. Dolly in: the camera physically moves forward through 3D space — nearby objects like beauty accessories pass by faster while the product stays centered, creating a parallax depth effect. NOT a digital zoom or image scale — the camera actually travels through the room. After reaching close to the product, the camera slowly pulls back, walking away and revealing the full vanity setting with beauty accessories and mirror. Beauty aesthetic atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "gym-bench":
    "A person holding a smartphone walks toward the product on a gym bench. Real handheld footage with natural camera shake and slight side-to-side sway. Dolly in: the camera physically moves forward through 3D space — nearby objects like fitness equipment pass by faster while the product stays centered, creating a parallax depth effect. NOT a digital zoom or image scale — the camera actually travels through the room. After reaching close to the product, the camera slowly pulls back, walking away and revealing the full gym setting with fitness equipment. Athletic atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
};
...
const WAREHOUSE_VIDEO_PROMPT =
  "A person holding a smartphone walks through a warehouse aisle toward a multi-tiered pallet display in the center. Real handheld footage with natural camera shake and slight side-to-side sway — like a TikTok video filmed on a phone. Dolly in for 4 seconds: the camera physically moves forward through 3D space — the metal shelving units on both sides slide past as the camera walks down the aisle, creating a strong parallax depth effect. NOT a digital zoom or image scale — the camera actually walks through the aisle, objects on the sides move past. After 4 seconds the camera slowly walks backward for 4 seconds, pulling away from the pallet display and revealing the full warehouse aisle with tall industrial shelving units receding into the distance. Dozens of identical products are stacked on the pallet display tiers with brand names and labels clearly visible. Bright overhead fluorescent lighting, concrete floor. The products stay perfectly still and in focus throughout. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.";

// ─── Standard BOF Prompt ───────────────────────────────────────────────
const STANDARD_BOF_VIDEO_PROMPT =
  "A person holding a smartphone walks toward the product. Real handheld footage with natural camera shake and slight side-to-side sway. Dolly in: the camera physically moves forward through 3D space, creating a parallax depth effect where nearby objects pass by faster than distant ones. NOT a digital zoom or image scale — the camera actually travels forward. The product is well-lit with studio lighting on a clean, neutral background. After reaching close to the product, the camera slowly pulls back, walking away to show the product in its full context. The product label and packaging are clearly visible. The product stays perfectly still and in focus throughout. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (wf === "intro-video-ai") {
      ...
      const motionPrompt =
        scenePreset === "custom" && customPrompt?.trim()
          ? `A person holding a smartphone walks toward the product. Real handheld footage with natural camera shake and slight side-to-side sway. Dolly in: the camera physically moves forward through 3D space, creating a parallax depth effect where nearby objects pass by faster than distant ones. NOT a digital zoom or image scale — the camera actually travels forward. After reaching close, the camera slowly pulls back, walking away. ${customPrompt.trim()} The product stays perfectly still and in focus throughout. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.`
