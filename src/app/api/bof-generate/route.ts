...
const WAREHOUSE_SCENE_PROMPT =
  "Place this product on a warehouse shelf or display table in a large, modern fulfillment center or big-box retail store. The product should be the main focus, clearly visible with its label and packaging facing the camera. The scene shows rows of shelving units, cardboard boxes, and industrial lighting overhead. Clean, organized, professional logistics environment. Bright, even lighting highlighting the product. Photorealistic, high quality product photography style.";

const WAREHOUSE_VIDEO_PROMPT =
  "A smooth camera glide through a modern warehouse or retail store, approaching the product on a shelf. The camera slowly pushes in, focusing on the product label and packaging. Industrial warehouse lighting creates clean, bright illumination. Shelves with organized boxes visible in background. Professional, clean atmosphere. The product stays perfectly still and in focus throughout. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.";
