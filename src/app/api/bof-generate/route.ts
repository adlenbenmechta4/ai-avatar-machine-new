...
const VIDEO_MOTION_PROMPTS: Record<string, string> = {
  "kitchen-counter":
    "Fast energetic handheld phone video. Camera quickly walks forward toward the product on the kitchen counter, background objects rush past with parallax motion, then camera quickly walks backward revealing the full kitchen. Shaky TikTok-style footage with visible hand tremor and walking bounce. Fast movement, NOT slow. NOT a still image with zoom. Real 3D camera movement through space. NO transitions, NO fade-in, NO fade-out.",
  "bathroom-counter":
    "Fast energetic handheld phone video. Camera quickly walks forward toward the product on the bathroom counter, background objects rush past with parallax motion, then camera quickly walks backward revealing the full bathroom. Shaky TikTok-style footage with visible hand tremor and walking bounce. Fast movement, NOT slow. NOT a still image with zoom. Real 3D camera movement through space. NO transitions, NO fade-in, NO fade-out.",
  "bedroom-nightstand":
    "Fast energetic handheld phone video. Camera quickly walks forward toward the product on the bedroom nightstand, background objects rush past with parallax motion, then camera quickly walks backward revealing the full bedroom. Shaky TikTok-style footage with visible hand tremor and walking bounce. Fast movement, NOT slow. NOT a still image with zoom. Real 3D camera movement through space. NO transitions, NO fade-in, NO fade-out.",
  "living-room":
    "Fast energetic handheld phone video. Camera quickly walks forward toward the product on the living room coffee table, background objects rush past with parallax motion, then camera quickly walks backward revealing the full living room. Shaky TikTok-style footage with visible hand tremor and walking bounce. Fast movement, NOT slow. NOT a still image with zoom. Real 3D camera movement through space. NO transitions, NO fade-in, NO fade-out.",
  "office-desk":
    "Fast energetic handheld phone video. Camera quickly walks forward toward the product on the office desk, background objects rush past with parallax motion, then camera quickly walks backward revealing the full workspace. Shaky TikTok-style footage with visible hand tremor and walking bounce. Fast movement, NOT slow. NOT a still image with zoom. Real 3D camera movement through space. NO transitions, NO fade-in, NO fade-out.",
  "outdoor-patio":
    "Fast energetic handheld phone video. Camera quickly walks forward toward the product on the outdoor patio table, background objects rush past with parallax motion, then camera quickly walks backward revealing the full patio. Shaky TikTok-style footage with visible hand tremor and walking bounce. Fast movement, NOT slow. NOT a still image with zoom. Real 3D camera movement through space. NO transitions, NO fade-in, NO fade-out.",
  "vanity-mirror":
    "Fast energetic handheld phone video. Camera quickly walks forward toward the product on the vanity table, background objects rush past with parallax motion, then camera quickly walks backward revealing the full vanity area. Shaky TikTok-style footage with visible hand tremor and walking bounce. Fast movement, NOT slow. NOT a still image with zoom. Real 3D camera movement through space. NO transitions, NO fade-in, NO fade-out.",
  "gym-bench":
    "Fast energetic handheld phone video. Camera quickly walks forward toward the product on the gym bench, background objects rush past with parallax motion, then camera quickly walks backward revealing the full gym. Shaky TikTok-style footage with visible hand tremor and walking bounce. Fast movement, NOT slow. NOT a still image with zoom. Real 3D camera movement through space. NO transitions, NO fade-in, NO fade-out.",
};
...
const WAREHOUSE_VIDEO_PROMPT =
  "Fast energetic handheld phone video inside a warehouse. Camera quickly walks forward down the aisle toward the pallet display, metal shelving units on both sides rush past with strong parallax motion. Then camera quickly walks backward pulling away from the pallet display and revealing the full warehouse aisle. Shaky TikTok-style footage with visible hand tremor and walking bounce. Fast movement, NOT slow. NOT a still image with zoom. Real 3D camera movement through the aisle. Brand names and labels on products clearly visible. Bright overhead fluorescent lighting, concrete floor. NO transitions, NO fade-in, NO fade-out.";

// ─── Standard BOF Prompt ───────────────────────────────────────────────
const STANDARD_BOF_VIDEO_PROMPT =
  "Fast energetic handheld phone video. Camera quickly walks forward toward the product, background objects rush past with parallax motion, then camera quickly walks backward revealing the product in full context. Shaky TikTok-style footage with visible hand tremor and walking bounce. Fast movement, NOT slow. NOT a still image with zoom. Real 3D camera movement through space. Product label and packaging clearly visible. NO transitions, NO fade-in, NO fade-out.";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (wf === "intro-video-ai") {
      ...
      const motionPrompt =
        scenePreset === "custom" && customPrompt?.trim()
          ? `Fast energetic handheld phone video. Camera quickly walks forward toward the product, background objects rush past with parallax motion, then camera quickly walks backward. Shaky TikTok-style footage with visible hand tremor and walking bounce. Fast movement, NOT slow. NOT a still image with zoom. Real 3D camera movement through space. ${customPrompt.trim()} NO transitions, NO fade-in, NO fade-out.`
