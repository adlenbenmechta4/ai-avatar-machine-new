...
const VIDEO_MOTION_PROMPTS: Record<string, string> = {
  "kitchen-counter":
    "The camera walks forward toward the product on the kitchen countertop, maintaining focus on the product label. The camera then walks backward, pulling away to reveal the full kitchen setting. Subtle natural light shifts as if clouds are passing outside the window. The product stays perfectly still and in focus. Warm, inviting kitchen atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "bathroom-counter":
    "The camera walks forward toward the product on the bathroom counter, maintaining focus on the product label. The camera then walks backward, pulling away to reveal the full bathroom setting. Soft light gently shifts creating subtle reflections on the marble surface. The product stays perfectly still and in focus. Clean, fresh atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "bedroom-nightstand":
    "The camera walks forward toward the product on the bedroom nightstand, maintaining focus on the product label. The camera then walks backward, pulling away to reveal the cozy bedroom setting. Warm lamp light creates a gentle glow around the product. The product stays perfectly still and in focus. Intimate, warm atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "living-room":
    "The camera walks forward toward the product on the coffee table, maintaining focus on the product label. The camera then walks backward, pulling away to reveal the full living room setting. Natural window light gently illuminates the scene. The product stays perfectly still and in focus. Comfortable, lifestyle atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "office-desk":
    "The camera walks forward toward the product on the office desk, maintaining focus on the product label. The camera then walks backward, pulling away to reveal the full workspace setting. Professional lighting remains consistent. The product stays perfectly still and in focus. Professional atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "outdoor-patio":
    "The camera walks forward toward the product on the patio table, maintaining focus on the product label. The camera then walks backward, pulling away to reveal the full outdoor patio setting. Natural sunlight creates gentle shadows that shift subtly. The product stays perfectly still and in focus. Fresh, bright outdoor atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "vanity-mirror":
    "The camera walks forward toward the product on the vanity table, maintaining focus on the product label. The camera then walks backward, pulling away to reveal the full vanity setting. Ring light creates soft, even illumination with gentle reflections in the mirror. The product stays perfectly still and in focus. Beauty aesthetic atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "gym-bench":
    "The camera walks forward toward the product on the gym bench, maintaining focus on the product label. The camera then walks backward, pulling away to reveal the full gym setting. Dynamic lighting creates subtle highlights and shadows. The product stays perfectly still and in focus. Athletic atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
};
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (wf === "intro-video-ai") {
      ...
      const motionPrompt =
        scenePreset === "custom" && customPrompt?.trim()
          ? `The camera walks forward toward the product, maintaining focus on the product label. The camera then walks backward, pulling away to reveal the full scene. ${customPrompt.trim()} The product stays perfectly still and in focus. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.`
