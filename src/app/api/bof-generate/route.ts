...
const VIDEO_MOTION_PROMPTS: Record<string, string> = {
  "kitchen-counter":
    "The camera approaches the product on the kitchen countertop and then retreats. The camera walks forward toward the product, getting close to the product label, and then walks backward, pulling away to reveal the full kitchen setting with marble countertops, coffee maker and fresh fruits. Subtle natural light shifts as if clouds are passing outside the window. The product stays perfectly still and in focus. Warm, inviting kitchen atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "bathroom-counter":
    "The camera approaches the product on the bathroom counter and then retreats. The camera walks forward toward the product, getting close to the product label, and then walks backward, pulling away to reveal the full bathroom setting with marble countertop and modern fixtures. Soft light gently shifts creating subtle reflections on the marble surface. The product stays perfectly still and in focus. Clean, fresh atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "bedroom-nightstand":
    "The camera approaches the product on the bedroom nightstand and then retreats. The camera walks forward toward the product, getting close to the product label, and then walks backward, pulling away to reveal the cozy bedroom setting with soft blankets and pillows. Warm lamp light creates a gentle glow around the product. The product stays perfectly still and in focus. Intimate, warm atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "living-room":
    "The camera approaches the product on the coffee table and then retreats. The camera walks forward toward the product, getting close to the product label, and then walks backward, pulling away to reveal the full living room setting with modern couch and stylish decor. Natural window light gently illuminates the scene. The product stays perfectly still and in focus. Comfortable, lifestyle atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "office-desk":
    "The camera approaches the product on the office desk and then retreats. The camera walks forward toward the product, getting close to the product label, and then walks backward, pulling away to reveal the full workspace setting with laptop and notepad. Professional lighting remains consistent. The product stays perfectly still and in focus. Professional atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "outdoor-patio":
    "The camera approaches the product on the patio table and then retreats. The camera walks forward toward the product, getting close to the product label, and then walks backward, pulling away to reveal the full outdoor patio setting with plants and outdoor furniture. Natural sunlight creates gentle shadows that shift subtly. The product stays perfectly still and in focus. Fresh, bright outdoor atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "vanity-mirror":
    "The camera approaches the product on the vanity table and then retreats. The camera walks forward toward the product, getting close to the product label, and then walks backward, pulling away to reveal the full vanity setting with beauty accessories and mirror. Ring light creates soft, even illumination with gentle reflections in the mirror. The product stays perfectly still and in focus. Beauty aesthetic atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
  "gym-bench":
    "The camera approaches the product on the gym bench and then retreats. The camera walks forward toward the product, getting close to the product label, and then walks backward, pulling away to reveal the full gym setting with fitness equipment. Dynamic lighting creates subtle highlights and shadows. The product stays perfectly still and in focus. Athletic atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.",
};
...
const WAREHOUSE_VIDEO_PROMPT =
  "The camera approaches the pallet display and then retreats. The camera walks forward down a warehouse aisle toward a multi-tiered pallet display, getting close to the products, and then walks backward, pulling away to reveal the full warehouse aisle with tall industrial shelving units on both sides. Dozens of identical products are stacked on the pallet display tiers with brand names and labels clearly visible. Bright overhead fluorescent lighting, concrete floor. The products stay perfectly still and in focus throughout. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.";

// ─── Standard BOF Prompt ───────────────────────────────────────────────
const STANDARD_BOF_VIDEO_PROMPT =
  "The camera approaches the product and then retreats. The camera walks forward toward the product, getting close to the product label, and then walks backward, pulling away to show the product in its full context. The product is well-lit with studio lighting on a clean, neutral background. The product label and packaging are clearly visible. The product stays perfectly still and in focus. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (wf === "intro-video-ai") {
      ...
      const motionPrompt =
        scenePreset === "custom" && customPrompt?.trim()
          ? `The camera approaches the product and then retreats. The camera walks forward toward the product, getting close to the product label, and then walks backward, pulling away to reveal the full scene. ${customPrompt.trim()} The product stays perfectly still and in focus. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness.`
