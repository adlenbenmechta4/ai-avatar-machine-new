...
const VIDEO_MOTION_PROMPTS: Record<string, string> = {
  "kitchen-counter":
    "Handheld camera footage filmed by a real person in a kitchen. The camera has natural subtle hand shake with slight sway and micro-jitters — organic handheld movement, not a stabilized gimbal. PHASE 1 (first half): The camera operator walks forward and slowly zooms IN on the product on the kitchen countertop, the product label and packaging becoming clearer as the camera gets closer. Subtle natural light shifts as if clouds are passing outside the window. PHASE 2 (second half): The camera operator slowly zooms OUT, pulling back to reveal the full kitchen setting with marble countertops, coffee maker and fresh fruits. The product stays perfectly still and in focus throughout. Warm, inviting kitchen atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness. Realistic handheld documentary style.",
  "bathroom-counter":
    "Handheld camera footage filmed by a real person in a bathroom. The camera has natural subtle hand shake with slight sway and micro-jitters — organic handheld movement, not a stabilized gimbal. PHASE 1 (first half): The camera operator walks forward and slowly zooms IN on the product on the bathroom counter, the product label and packaging becoming clearer as the camera gets closer. Soft light gently shifts creating subtle reflections on the marble surface. PHASE 2 (second half): The camera operator slowly zooms OUT, pulling back to reveal the full bathroom setting with marble countertop and modern fixtures. The product stays perfectly still and in focus throughout. Clean, fresh atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness. Realistic handheld documentary style.",
  "bedroom-nightstand":
    "Handheld camera footage filmed by a real person in a bedroom. The camera has natural subtle hand shake with slight sway and micro-jitters — organic handheld movement, not a stabilized gimbal. PHASE 1 (first half): The camera operator walks forward and slowly zooms IN on the product on the nightstand, the product label and packaging becoming clearer as the camera gets closer. Warm lamp light creates a gentle glow around the product. PHASE 2 (second half): The camera operator slowly zooms OUT, pulling back to reveal the cozy bedroom setting with soft blankets and pillows. The product stays perfectly still and in focus throughout. Intimate, warm atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness. Realistic handheld documentary style.",
  "living-room":
    "Handheld camera footage filmed by a real person in a living room. The camera has natural subtle hand shake with slight sway and micro-jitters — organic handheld movement, not a stabilized gimbal. PHASE 1 (first half): The camera operator walks forward and slowly zooms IN on the product on the coffee table, the product label and packaging becoming clearer as the camera gets closer. Natural window light gently illuminates the scene. PHASE 2 (second half): The camera operator slowly zooms OUT, pulling back to reveal the full living room with modern couch and stylish decor. The product stays perfectly still and in focus throughout. Comfortable, lifestyle atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness. Realistic handheld documentary style.",
  "office-desk":
    "Handheld camera footage filmed by a real person in an office. The camera has natural subtle hand shake with slight sway and micro-jitters — organic handheld movement, not a stabilized gimbal. PHASE 1 (first half): The camera operator walks forward and slowly zooms IN on the product on the office desk, the product label and packaging becoming clearer as the camera gets closer. Professional lighting remains consistent. PHASE 2 (second half): The camera operator slowly zooms OUT, pulling back to reveal the full workspace with laptop and notepad. The product stays perfectly still and in focus throughout. Professional atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness. Realistic handheld documentary style.",
  "outdoor-patio":
    "Handheld camera footage filmed by a real person on an outdoor patio. The camera has natural subtle hand shake with slight sway and micro-jitters — organic handheld movement, not a stabilized gimbal. PHASE 1 (first half): The camera operator walks forward and slowly zooms IN on the product on the patio table, the product label and packaging becoming clearer as the camera gets closer. Natural sunlight creates gentle shadows that shift subtly. PHASE 2 (second half): The camera operator slowly zooms OUT, pulling back to reveal the full patio setting with plants and outdoor furniture. The product stays perfectly still and in focus throughout. Fresh, bright outdoor atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness. Realistic handheld documentary style.",
  "vanity-mirror":
    "Handheld camera footage filmed by a real person at a vanity table. The camera has natural subtle hand shake with slight sway and micro-jitters — organic handheld movement, not a stabilized gimbal. PHASE 1 (first half): The camera operator walks forward and slowly zooms IN on the product on the vanity table, the product label and packaging becoming clearer as the camera gets closer. Ring light creates soft, even illumination with gentle reflections in the mirror. PHASE 2 (second half): The camera operator slowly zooms OUT, pulling back to reveal the full vanity setting with beauty accessories and mirror. The product stays perfectly still and in focus throughout. Beauty aesthetic atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness. Realistic handheld documentary style.",
  "gym-bench":
    "Handheld camera footage filmed by a real person in a gym. The camera has natural subtle hand shake with slight sway and micro-jitters — organic handheld movement, not a stabilized gimbal. PHASE 1 (first half): The camera operator walks forward and slowly zooms IN on the product on the gym bench, the product label and packaging becoming clearer as the camera gets closer. Dynamic lighting creates subtle highlights and shadows. PHASE 2 (second half): The camera operator slowly zooms OUT, pulling back to reveal the full gym setting with fitness equipment. The product stays perfectly still and in focus throughout. Athletic atmosphere. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness. Realistic handheld documentary style.",
};
...
const STANDARD_BOF_VIDEO_PROMPT =
  "Handheld camera footage filmed by a real person. The camera has natural subtle hand shake with slight sway and micro-jitters — organic handheld movement, not a stabilized gimbal. PHASE 1 (first half): The camera operator slowly zooms IN on the product, the product label and packaging becoming clearer as the camera gets closer. The product is well-lit with studio lighting on a clean, neutral background. PHASE 2 (second half): The camera operator slowly zooms OUT, pulling back to show the product in its full context. The product label and packaging are clearly visible. The product stays perfectly still and in focus throughout. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness. Realistic handheld documentary style.";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (wf === "intro-video-ai") {
      ...
      const motionPrompt =
        scenePreset === "custom" && customPrompt?.trim()
          ? `Handheld camera footage filmed by a real person. The camera has natural subtle hand shake with slight sway and micro-jitters — organic handheld movement, not a stabilized gimbal. PHASE 1 (first half): The camera operator slowly zooms IN on the product, the product label and packaging becoming clearer. PHASE 2 (second half): The camera operator slowly zooms OUT, pulling back to reveal the full scene. ${customPrompt.trim()} The product stays perfectly still and in focus throughout. NO transitions, NO fade-in, NO fade-out. Start instantly at full brightness. Realistic handheld documentary style.`
