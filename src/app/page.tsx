...
function UserMenu({ userData, onShowSubscription, theme }: {
  ...
  // ─── Profile Panel Content (shared between desktop & mobile) ────────────
  const profilePanel = (
    <div
  ...
  return (
    <div className="fixed top-4 right-4 z-[60]">
      ...
      <div className="hidden sm:flex items-center gap-3">
        ...
        <div className="relative">
          ...
          >
            ...
            <svg className="w-3.5 h-3.5 transition-transform duration-200" style={{ transform: showMenu ? "rotate(180deg)" : "rotate(0deg)" }} viewBox="0 0 20 20" fill={C.textMuted}>
      ...
      {/* Mobile: compact avatar trigger + same popup */}
      <div className="sm:hidden relative">
        ...
        {showMenu && (
          <>
            <div className="fixed inset-0 z-40" onClick={() => setShowMenu(false)} />
            <div className="absolute right-0 top-full mt-2.5 z-50" style={{ maxWidth: "calc(100vw - 2rem)" }}>
              {profilePanel}
            </div>
          </>
        )}
